...
General Circulation Models (GCMs) are a powerful tool for understanding the meteorology and climate of the high latitudes, which are among the most sensitive regions on Earth to global and environmental change. Despite their importance,  not all GCMs treat the polar regions the same way as they do elsewhere in the domain due to the so called \textit{pole-problem} \cite{W2007JMSJ}. The wide variety of grids structures and numerical techniques used to represent polar regions in conventional GCMs are evaluated in this study for their impacts on the meteorology and climate of the Arctic, with a special focus on the Greenland Ice Sheet.
