...
The Arctic region has a unique geography. It consists of a polar ocean encircled by the northern coasts of the northern hemisphere continents and the large island of Greenland, and capped by sea ice for half the year. Greenland is covered in a kilometers thick ice sheet, and receives a substantial portion of its snowfall from synoptic-scale storms traversing up the eastern sea-board of North America, and steered in the direction of the Icelandic low. Katabatic winds accelerate down the steep slopes of the Greenland Ice Sheet (GrIS) in episodic bursts that can clear out sea ice from its fjords and surrounding coastal region. Large volumes of fresh water are drained into the ocean through river outlets in Canada and Russia, ice discharge and melt water runoff from the periphery of GrIS. Polar Lows form during the cold season and their gale-speed winds can kick up large waves and pose a hazard to mariners' and coastal communities. These Arctic processes have proven challenging to represent in GCMs, primarily due to the fine-scales involved \cite{BETAL2001MWR,SG2017MWR,VETAL2018TC}. As such, the Arctic serves as a test-bed for comparing the simulated meteorology and climate in the SE and FV dycores. 
