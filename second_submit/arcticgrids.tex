...
{\color{blue}{Changes in surface albedo may also explain the melt differences across the grids and dycores. The top and middle rows of Figure~\ref{fig:alb} show maps of summer albedo biases in the simulations, relative to the RACMO2.3p2 and the processed MODIS albedo dataset of \citeA{MODIS}. The model surface albedo is diagnosed from the incident and net shortwave radiative fluxes at the surface. Both RACMO2.3p2 and MODIS datasets indicate that the albedo in the quasi-uniform grids is lower in the central-west and northwest region, relative to the other grids, whereas the albedo is anomalously low at the southwest and southeast coastal margins in both lat-lon and quasi-uniform grids, compared with the VR grids. All grids and dycores have a positive albedo anomaly in northeast Greenland.
